...
#define AUTH_INFO	"Jason"

#define DEVID		"smarthome_01"
		...
		case MQTT_PKT_PUBLISH:														//接收的Publish消息
			...
			if(result == 0)
			{
				...
				{//解析开关值
					...
					{
						json_value = cJSON_GetObjectItem(json, "value");
						if(json_value->valueint)alarmFlag = 1;	//开蜂鸣器
						else alarmFlag = 0;						//关蜂鸣器
						alarm_is_free = 0;
					}
					
//					if(json_value->valueint)  //json_value大于0且为整形
//					{
//						LED0 = 1;	//打开led0
//					}
//					else
